...
public:
  ...
  Standard_EXPORT ProjLib_ProjectOnSurface(const Handle(GeomAdaptor_Surface)& S);
  ...
  Standard_EXPORT void Load(const Handle(GeomAdaptor_Curve)& C, const Standard_Real Tolerance);
