...
Extrema_GlobOptFuncCQuadric::Extrema_GlobOptFuncCQuadric(const GeomAdaptor_Curve*   C,
...
void Extrema_GlobOptFuncCQuadric::LoadQuad(const GeomAdaptor_Surface* S,
