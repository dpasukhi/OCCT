...
public:
  ...
  Standard_EXPORT explicit ExtremaPC_Circle(const gp_Circ& theCircle);
  ...
  Standard_EXPORT ExtremaPC_Circle(const gp_Circ& theCircle, const ExtremaPC::Domain1D& theDomain);
  ...
  //! Evaluates a point on the circle.
