                                        ...
                                        const ExtremaPC2d::Domain1D& theDomain)
{
  ...
  switch (aCurveType)
  {
    ...
    case GeomAbs_OffsetCurve:
      myAdaptorOwned = theCurve.ShallowCopy();
      if (!myAdaptorOwned.IsNull())
      {
        myEvaluator = ExtremaPC2d_OffsetCurve(*myAdaptorOwned, theDomain);
      }
      break;
    ...
    default:
      ...
      if (!myAdaptorOwned.IsNull())
      {
        myEvaluator = ExtremaPC2d_OtherCurve(*myAdaptorOwned, theDomain);
      }
      break;
  }
}
...
const ExtremaPC2d::Result& ExtremaPC2d_Curve::PerformWithEndpoints(const gp_Pnt2d&         theP,
                                                               double                theTol,
                                                               ExtremaPC2d::SearchMode theMode) const
{
  const ExtremaPC2d::Result* aResultPtr = &THE_NOT_DONE_RESULT;
