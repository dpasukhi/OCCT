...

{
  ...
  double bidon;
  int    ii, nd;
  const double* aMaxValues = PLib_JacobiPolynomial::MaxValuesData(GeomAbs_C0);
             ...
             double* errmax)
{
  ...
  double bidon;
  int    ii, nd;
  const double* aMaxValues = PLib_JacobiPolynomial::MaxValuesData(GeomAbs_C1);
...

{
  ...
  double bidon;
  int    ii, nd;
  const double* aMaxValues = PLib_JacobiPolynomial::MaxValuesData(GeomAbs_C2);
