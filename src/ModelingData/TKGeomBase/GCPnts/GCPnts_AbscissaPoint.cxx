...
Standard_Real GCPnts_AbscissaPoint::Length(const GeomAdaptor_Curve& theC)
{
...
Standard_Real GCPnts_AbscissaPoint::Length(const GeomAdaptor_Curve& theC, const Standard_Real theTol)
{
...
GCPnts_AbscissaPoint::GCPnts_AbscissaPoint(const GeomAdaptor_Curve& theC,
                                           const Standard_Real    theAbscissa,
                                           const Standard_Real    theU0)
{
