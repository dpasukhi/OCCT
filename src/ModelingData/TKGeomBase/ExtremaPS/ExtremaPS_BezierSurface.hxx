...
//! Point-Bezier-surface extrema computation.
//!
...
public:
  ...
  const occ::handle<Geom_BezierSurface>& Surface() const { return mySurface; }
...
private:
  ...
  GeomAdaptor_Surface             myAdaptor; //!< Surface adaptor
