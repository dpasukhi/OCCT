...
public:
  ...
  Standard_EXPORT static void Value(const Handle(GeomAdaptor_Curve)& C,
                                    const Standard_Real            U,
                                    gp_Pnt&                        P);

  //! Computes the point <P> and first derivative <V1> of
  //! parameter <U> on the HCurve <C>.
  Standard_EXPORT static void D1(const Handle(GeomAdaptor_Curve)& C,
                                 const Standard_Real            U,
                                 gp_Pnt&                        P,
                                 gp_Vec&                        V1);
  ...
  Standard_EXPORT static void D2(const Handle(GeomAdaptor_Curve)& C,
                                 const Standard_Real            U,
                                 gp_Pnt&                        P,
                                 gp_Vec&                        V1,
                                 gp_Vec&                        V2);
  ...
  //! parameter <U> on the HCurve <C>.
  Standard_EXPORT static void D3(const Handle(GeomAdaptor_Curve)& C,
                                 const Standard_Real            U,
                                 gp_Pnt&                        P,
                                 gp_Vec&                        V1,
                                 gp_Vec&                        V2,
  ...
  Standard_EXPORT static Standard_Integer Continuity(const Handle(GeomAdaptor_Curve)& C);

  //! returns the first parameter bound of the HCurve.
  Standard_EXPORT static Standard_Real FirstParameter(const Handle(GeomAdaptor_Curve)& C);

  //! returns the last parameter bound of the HCurve.
  //! FirstParameter must be less than LastParamenter.
  Standard_EXPORT static Standard_Real LastParameter(const Handle(GeomAdaptor_Curve)& C);
