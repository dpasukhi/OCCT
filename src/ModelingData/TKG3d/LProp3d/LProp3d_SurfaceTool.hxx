...
public:
  ...
  //! HSurface <S>.
  Standard_EXPORT static void Value(const Handle(GeomAdaptor_Surface)& S,
  ...
  Standard_EXPORT static void D1(const Handle(GeomAdaptor_Surface)& S,
                                 const Standard_Real              U,
                                 const Standard_Real              V,
                                 gp_Pnt&                          P,
                                 gp_Vec&                          D1U,
  ...
  Standard_EXPORT static void D2(const Handle(GeomAdaptor_Surface)& S,
                                 const Standard_Real              U,
                                 const Standard_Real              V,
                                 gp_Pnt&                          P,
                                 gp_Vec&                          D1U,
  ...
  Standard_EXPORT static gp_Vec DN(const Handle(GeomAdaptor_Surface)& S,
                                   const Standard_Real              U,
                                   const Standard_Real              V,
  ...
  Standard_EXPORT static Standard_Integer Continuity(const Handle(GeomAdaptor_Surface)& S);

  //! returns the bounds of the HSurface.
  Standard_EXPORT static void Bounds(const Handle(GeomAdaptor_Surface)& S,
                                     Standard_Real&                   U1,
                                     Standard_Real&                   V1,
                                     Standard_Real&                   U2,
                                     Standard_Real&                   V2);
