...
public:
  ...
  GeomHash_Accumulator()
      : myValue(opencascade::MurmurHash::optimalSeed<TheHashType>())
  {
  }
...
private:
  void append(const void* theData, const size_t theSize)
  {
    ...
    {
      myValue = opencascade::MurmurHash::MurmurHash64A(theData, static_cast<int>(theSize), myValue);
    }
    else
    {
      myValue = opencascade::MurmurHash::MurmurHash2A(theData, static_cast<int>(theSize), myValue);
    }
  }
