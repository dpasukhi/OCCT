...
IMPLEMENT_STANDARD_RTTIEXT(ODE_Curve3dFile, Standard_Transient)

//=================================================================================================

ODE_Curve3dFile::ODE_Curve3dFile()
: myInstanceCount(0)
{
}
...
ODE_ObjectRef ODE_Curve3dFile::AddCurve(const Handle(Geom_Curve)& theCurve)
{
  if (theCurve.IsNull())
  {
  ...
  const ODEHash_Curve3dHasher aHasher;
  ...
  if (it != myHashToIndex.end())
  {
    ...
    if (aHasher(anEntry.MyCurve, theCurve))
    {
      ...
      return ODE_ObjectRef("curves3d", anIndex, anEntry.SubIndexCount - 1);
    }
  }
  ...
  return ODE_ObjectRef("curves3d", aNewIndex);
}

//=================================================================================================

Handle(Geom_Curve) ODE_Curve3dFile::GetCurve(const ODE_ObjectRef& theRef) const
{
  if (theRef.FileType() != "curves3d")
  {
    return nullptr;
  }
...
int ODE_Curve3dFile::CurveCount() const
{
...
int ODE_Curve3dFile::InstanceCount() const
{
...
ODE_Status ODE_Curve3dFile::WriteToFile(const TCollection_AsciiString& thePath) const
{
...
ODE_Status ODE_Curve3dFile::ReadFromFile(const TCollection_AsciiString& thePath)
{
