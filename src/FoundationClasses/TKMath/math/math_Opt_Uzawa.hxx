...
#ifndef _math_Opt_Uzawa_HeaderFile
#define _math_Opt_Uzawa_HeaderFile
                         ...
                         const UzawaConfig& theConfig = UzawaConfig())
{
  ...
  if (theNci == 0)
  {
    ...
    // Invert using Crout
    Lin::InverseResult aInvResult = Lin::InvertCrout(aCTCinv);
...
#endif // _math_Opt_Uzawa_HeaderFile
