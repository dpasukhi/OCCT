...
#ifndef _math_Functor_Vector_HeaderFile
#define _math_Functor_Vector_HeaderFile
...
//! math API (math::Min::Powell, math::Min::BFGS, math::Sys::Newton) without
...
//!   return true;
//! });
//! auto aResult = math::Min::Powell(aFunc, aStartPoint);
//! @endcode
//!
...
//!     return true;
//!   });
//! auto aResult = math::Min::BFGS(aFunc, aStartPoint);
//! @endcode
//!
...
//! auto aResult = math::Min::BFGS(aRosen, aStart);
...
//! math_Vector aStart(1, 2);
//! aStart.Init(0.0);
//! auto aResult = math::Min::BFGS(aRes, aStart);
//! @endcode
...
//!   return true;
//! });
//! auto aResult = math::Sys::Newton(aSys, aStartPoint);
//! @endcode
//!
...
#endif // _math_Functor_Vector_HeaderFile
