...
#ifndef _math_Integ_DoubleExp_HeaderFile
#define _math_Integ_DoubleExp_HeaderFile
                     ...
                     const DoubleExpConfig& theConfig = DoubleExpConfig())
{
  ...
  for (int aLevel = 0; aLevel < theConfig.NbLevels; ++aLevel)
  {
    ...
    for (int k = aStart;; k += aStep)
    {
      ...
      if (aX <= theLower + Internal::THE_ZERO_TOL || aX >= theUpper - Internal::THE_ZERO_TOL)
      {
        break;
      }
      ...
      if (aWeight < Internal::THE_ZERO_TOL)
      {
        break;
      }
...
#endif // _math_Integ_DoubleExp_HeaderFile
