...
TEST(math_Min_FRPR_NewTest, Quadratic_FletcherReeves)
{
  QuadraticFunc aFunc;
  ...
  math::Min::FRPRConfig aConfig;
  aConfig.MaxIterations = 100;
  aConfig.Tolerance     = 1.0e-8;
  aConfig.Formula       = math::Min::ConjugateGradientFormula::FletcherReeves;

  auto aResult = math::Min::FRPR(aFunc, aStart, aConfig);
...
TEST(math_Min_FRPR_NewTest, Quadratic_PolakRibiere)
{
  QuadraticFunc aFunc;
  ...
  aConfig.MaxIterations = 100;
  aConfig.Tolerance     = 1.0e-8;
  aConfig.Formula       = math::Min::ConjugateGradientFormula::PolakRibiere;
...
TEST(math_Min_FRPR_NewTest, Booth)
{
  BoothFunc aFunc;
...
TEST(math_Min_FRPR_NewTest, Rosenbrock)
{
...
TEST(math_Min_FRPR_NewTest, Sphere3D)
{
  SphereFunc aFunc;
...
TEST(math_Min_FRPR_NewTest, Sphere5D)
{
  SphereFunc aFunc;
...
TEST(math_Min_FRPR_NewTest, NumericalGradient_Quadratic)
{
  // Value-only function
  ...
  auto aResult = math::Min::FRPRNumerical(aFunc, aStart, 1.0e-8, aConfig);
...
TEST(math_Min_FRPR_NewTest, CompareWithOldAPI_Quadratic)
{
  ...
  aConfig.MaxIterations = 100;
  aConfig.Tolerance     = 1.0e-8;
  auto aNewResult       = math::Min::FRPR(aNewFunc, aStart, aConfig);
...
TEST(math_Min_FRPR_NewTest, CompareWithOldAPI_Rosenbrock)
{
...
TEST(math_Min_FRPR_NewTest, CompareWithBFGS)
{
  QuadraticFunc aFunc;
  ...
  math::Min::FRPRConfig aFRPRConfig;
  aFRPRConfig.MaxIterations = 100;
  aFRPRConfig.Tolerance     = 1.0e-8;

  auto aFRPRResult = math::Min::FRPR(aFunc, aStart, aFRPRConfig);
  auto aBFGSResult = math::Min::BFGS(aFunc, aStart, aConfig);
...
TEST(math_Min_FRPR_NewTest, FormulaComparison)
{
  QuadraticFunc aFunc;
  ...
  math::Min::FRPRConfig aConfigFR;
  aConfigFR.MaxIterations = 100;
  aConfigFR.Tolerance     = 1.0e-8;
  aConfigFR.Formula       = math::Min::ConjugateGradientFormula::FletcherReeves;

  math::Min::FRPRConfig aConfigPR;
  aConfigPR.MaxIterations = 100;
  aConfigPR.Tolerance     = 1.0e-8;
  aConfigPR.Formula       = math::Min::ConjugateGradientFormula::PolakRibiere;

  math::Min::FRPRConfig aConfigHS;
  aConfigHS.MaxIterations = 100;
  aConfigHS.Tolerance     = 1.0e-8;
  aConfigHS.Formula       = math::Min::ConjugateGradientFormula::HestenesStiefel;

  auto aResultFR = math::Min::FRPR(aFunc, aStart, aConfigFR);
  auto aResultPR = math::Min::FRPR(aFunc, aStart, aConfigPR);
  auto aResultHS = math::Min::FRPR(aFunc, aStart, aConfigHS);
