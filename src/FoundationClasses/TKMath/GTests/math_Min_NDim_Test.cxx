...
TEST(math_Min_PowellTest, SimpleQuadratic)
{
  ...
  auto aResult = math::Min::Powell(aFunc, aStart, aConfig);
...
TEST(math_Min_PowellTest, BoothFunction)
{
  BoothFunction aFunc;
  math_Vector   aStart(1, 2);
  aStart(1) = 0.0;
...
TEST(math_Min_PowellTest, SphereFunction3D)
{
...
TEST(math_Min_BFGSTest, SimpleQuadratic)
{
  SimpleQuadratic aFunc;
  math_Vector     aStart(1, 2);
  aStart(1) = 5.0;
  ...
  auto aResult = math::Min::BFGS(aFunc, aStart, aConfig);
...
TEST(math_Min_BFGSTest, BoothFunction)
{
  BoothFunction aFunc;
  math_Vector   aStart(1, 2);
  aStart(1) = 0.0;
...
TEST(math_Min_BFGSTest, RosenbrockFunction)
{
...
TEST(math_Min_BFGSTest, BealeFunction)
{
  BealeFunction aFunc;
  math_Vector   aStart(1, 2);
  aStart(1) = 0.0;
...
TEST(math_Min_BFGSTest, SphereFunction5D)
{
  SphereFunction aFunc;
...
TEST(math_Min_BFGSNumericalTest, SimpleQuadratic)
{
  ...
  auto aResult = math::Min::BFGSNumerical(aFunc, aStart, 1.0e-7, aConfig);
...
TEST(math_Min_LBFGSTest, SimpleQuadratic)
{
  SimpleQuadratic aFunc;
  math_Vector     aStart(1, 2);
  aStart(1) = 5.0;
  ...
  auto aResult = math::Min::LBFGS(aFunc, aStart, 10, aConfig);
...
TEST(math_Min_LBFGSTest, BoothFunction)
{
  BoothFunction aFunc;
  math_Vector   aStart(1, 2);
  aStart(1) = 0.0;
...
TEST(math_Min_LBFGSTest, SphereFunction10D)
{
  SphereFunction aFunc;
  ...
  auto aResult = math::Min::LBFGS(aFunc, aStart, 5, aConfig);
...
TEST(math_Min_ComparisonTest, BFGSFasterThanPowellOnQuadratic)
{
  SimpleQuadratic aFunc;
  math_Vector     aStart(1, 2);
  aStart(1) = 10.0;
  ...
  auto aPowellResult = math::Min::Powell(aFunc, aStart, aConfig);
