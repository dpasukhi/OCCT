...
TEST(math_Min_GlobOpt_NewTest, GlobalMinimum_PSO_Sphere)
{
  SphereFunc aFunc;
  ...
  math::Min::GlobalConfig aConfig(math::Min::GlobalStrategy::PSO, 100);
  aConfig.NbPopulation = 40;
  aConfig.Seed         = 42;

  auto aResult = math::Min::GlobalMinimum(aFunc, aLower, aUpper, aConfig);
...
TEST(math_Min_GlobOpt_NewTest, GlobalMinimum_MultiStart_Sphere)
{
  SphereFunc aFunc;
  ...
  math::Min::GlobalConfig aConfig(math::Min::GlobalStrategy::MultiStart, 100);
  aConfig.NbStarts = 20;
  aConfig.Seed     = 42;
...
TEST(math_Min_GlobOpt_NewTest, GlobalMinimum_PSOHybrid_Booth)
{
  BoothFunc aFunc;
  ...
  math::Min::GlobalConfig aConfig(math::Min::GlobalStrategy::PSOHybrid, 100);
  aConfig.NbPopulation = 40;
  aConfig.Seed         = 42;
...
TEST(math_Min_GlobOpt_NewTest, GlobalMinimum_DE_Sphere)
{
  SphereFunc aFunc;
  ...
  math::Min::GlobalConfig aConfig(math::Min::GlobalStrategy::DifferentialEvolution, 100);
  aConfig.NbPopulation  = 40;
...
TEST(math_Min_GlobOpt_NewTest, DifferentialEvolution_Sphere)
{
  SphereFunc aFunc;
  ...
  auto aResult = math::Min::DifferentialEvolution(aFunc, aLower, aUpper, aConfig);
...
TEST(math_Min_GlobOpt_NewTest, DifferentialEvolution_Rosenbrock)
{
...
TEST(math_Min_GlobOpt_NewTest, DifferentialEvolution_Rastrigin)
{
  RastriginFunc aFunc;
...
TEST(math_Min_GlobOpt_NewTest, MultiStart_Sphere)
{
  SphereFunc aFunc;
  ...
  auto aResult = math::Min::MultiStart(aFunc, aLower, aUpper, aConfig);
...
TEST(math_Min_GlobOpt_NewTest, MultiStart_Booth)
{
  BoothFunc aFunc;
...
TEST(math_Min_GlobOpt_NewTest, Himmelblau_FindsOneMinimum)
{
  ...
  math::Min::GlobalConfig aConfig(math::Min::GlobalStrategy::DifferentialEvolution, 200);
  aConfig.NbPopulation = 50;
  aConfig.Seed         = 42;
...
TEST(math_Min_GlobOpt_NewTest, GoldsteinPrice)
{
...
TEST(math_Min_GlobOpt_NewTest, DifferentialEvolution_Sphere5D)
{
  SphereFunc aFunc;
...
TEST(math_Min_GlobOpt_NewTest, StrategyComparison_Rosenbrock)
{
  RosenbrockFunc aFunc;
  ...
  // Test PSO
  math::Min::GlobalConfig aConfigPSO(math::Min::GlobalStrategy::PSO, 200);
  aConfigPSO.NbPopulation = 50;
  aConfigPSO.Seed         = 42;
  auto aResultPSO         = math::Min::GlobalMinimum(aFunc, aLower, aUpper, aConfigPSO);

  // Test DE
  math::Min::GlobalConfig aConfigDE(math::Min::GlobalStrategy::DifferentialEvolution, 200);
  aConfigDE.NbPopulation = 50;
  aConfigDE.Seed         = 42;
  auto aResultDE         = math::Min::GlobalMinimum(aFunc, aLower, aUpper, aConfigDE);
...
TEST(math_Min_GlobOpt_NewTest, Reproducibility_DE)
{
  SphereFunc aFunc;
  ...
  auto aResult1 = math::Min::DifferentialEvolution(aFunc, aLower, aUpper, aConfig);
  auto aResult2 = math::Min::DifferentialEvolution(aFunc, aLower, aUpper, aConfig);
...
TEST(math_Min_GlobOpt_NewTest, CompareWithOldAPI_Sphere)
{
  ...
  aConfig.NbPopulation = 40;
  aConfig.Seed         = 42;
  auto aNewResult      = math::Min::GlobalMinimum(aNewFunc, aLower, aUpper, aConfig);
