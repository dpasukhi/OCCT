...
TEST(math_Sys_ComparisonTest, Newton_CircleLineSystem)
{
  ...
  // Solve using new API
  auto aNewResult = math::Sys::Newton(aFunc, aStart, aTolX, aTolF);
...
TEST(math_Sys_ComparisonTest, Newton_RosenbrockSystem)
{
...
TEST(math_Sys_ComparisonTest, Newton_Linear3System)
{
  Linear3System aFunc;
...
TEST(math_Sys_ComparisonTest, Newton_PolynomialSystem)
{
...
TEST(math_Sys_ComparisonTest, NewtonBounded_CircleLineSystem)
{
  SimpleCircleLineSystem aFunc;
  ...
  auto aNewResult = math::Sys::NewtonBounded(aFunc, aStart, aInfBound, aSupBound, aTolX, aTolF);
  ASSERT_TRUE(aNewResult.IsDone());
...
TEST(math_Sys_ComparisonTest, Newton_VerifyFunctionValues)
{
  SimpleCircleLineSystem aFunc;
  ...
  auto aResult = math::Sys::Newton(aFunc, aStart, 1.0e-10, 1.0e-10);
...
TEST(math_Sys_ComparisonTest, IterationCount_NewVsOld)
{
  RosenbrockSystem aFunc;
...
TEST(math_Sys_ComparisonTest, Newton_UniformTolerance)
{
  SimpleCircleLineSystem aFunc;
...
TEST(math_Sys_ComparisonTest, Newton_DifferentStartingPoints)
{
  SimpleCircleLineSystem aFunc;
