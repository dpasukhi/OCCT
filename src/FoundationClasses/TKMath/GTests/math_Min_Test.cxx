...
TEST(math_Min_BrentTest, SimpleParabola)
{
  ParabolaFunc aFunc;
...
TEST(math_Min_GoldenTest, SimpleParabola)
{
  ParabolaFunc aFunc;
...
TEST(math_Min_BrentWithBracketTest, SimpleParabola)
{
  ParabolaFunc aFunc;
...
TEST(math_Min_ComparisonTest, BrentVsGoldenSameResult)
{
  ParabolaFunc aFunc;

  math::ScalarResult aBrent = math::Min::Brent(aFunc, 0.0, 10.0);
  math::ScalarResult aGolden = math::Min::Golden(aFunc, 0.0, 10.0);
...
TEST(math_Min_ComparisonTest, BrentFasterThanGolden)
{
  ...
  math::ScalarResult aBrent = math::Min::Brent(aFunc, 0.0, 10.0, aConfig);
  math::ScalarResult aGolden = math::Min::Golden(aFunc, 0.0, 10.0, aConfig);
...
TEST(math_Min_RobustnessTest, MinimumAtLeftBoundary)
{
...
TEST(math_Min_BoolConversionTest, SuccessfulResultIsTrue)
{
  ParabolaFunc aFunc;
  math::ScalarResult aResult = math::Min::Brent(aFunc, 0.0, 10.0);
...
TEST(math_Min_IterationTest, BrentConvergesQuickly)
{
  ParabolaFunc aFunc;
  math::ScalarResult aResult = math::Min::Brent(aFunc, 0.0, 10.0);
  ASSERT_TRUE(aResult.IsDone());
...
TEST(math_Min_IterationTest, GoldenConverges)
{
  ParabolaFunc aFunc;
  math::ScalarResult aResult = math::Min::Golden(aFunc, 0.0, 10.0);
  ASSERT_TRUE(aResult.IsDone());
