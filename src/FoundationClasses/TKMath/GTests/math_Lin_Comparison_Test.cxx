...
TEST(math_Lin_ComparisonTest, Solve_3x3System)
{
  // Create a 3x3 matrix
  ...
  // Solve using new API
  auto aNewResult = math::Lin::Solve(aA, aB);
...
TEST(math_Lin_ComparisonTest, Solve_5x5System)
{
...
TEST(math_Lin_ComparisonTest, Determinant_3x3Matrix)
{
  ...
  auto aNewResult = math::Lin::Determinant(aA);
  ASSERT_TRUE(aNewResult.IsDone());
...
TEST(math_Lin_ComparisonTest, Determinant_IdentityMatrix)
{
  ...
  // Compute using new API
  auto aNewResult = math::Lin::Determinant(aI);
  ASSERT_TRUE(aNewResult.IsDone());
...
TEST(math_Lin_ComparisonTest, Invert_3x3Matrix)
{
  // Create a 3x3 matrix
  math_Matrix aA(1, 3, 1, 3);
  ...
  auto aNewResult = math::Lin::Invert(aA);
  ASSERT_TRUE(aNewResult.IsDone());
...
TEST(math_Lin_ComparisonTest, Invert_VerifyByMultiplication)
{
  // Create a 3x3 matrix
  math_Matrix aA(1, 3, 1, 3);
...
TEST(math_Lin_ComparisonTest, LU_Decomposition)
{
  // Create a 3x3 matrix
  math_Matrix aA(1, 3, 1, 3);
  aA(1, 1) = 2.0; aA(1, 2) = 1.0; aA(1, 3) = 1.0;
  ...
  auto aSolveResult = math::Lin::Solve(aA, aB);
...
TEST(math_Lin_ComparisonTest, SingularMatrix_Detection)
{
  ...
  auto aNewResult = math::Lin::LU(aA);
...
TEST(math_Lin_ComparisonTest, IllConditioned_HilbertMatrix)
{
  ...
  // Solve using new API
  auto aNewResult = math::Lin::Solve(aH, aB);
  ASSERT_TRUE(aNewResult.IsDone());
...
TEST(math_Lin_ComparisonTest, Determinant_MultipleMatrices)
{
...
TEST(math_Lin_ComparisonTest, Solve_KnownSolution)
{
...
TEST(math_Lin_ComparisonTest, Solve_ComplexKnownSolution)
{
