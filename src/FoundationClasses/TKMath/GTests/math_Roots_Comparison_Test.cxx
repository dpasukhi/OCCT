...
// ============================================================================
// math_BissecNewton vs math::Roots::BisectionNewton comparison tests
// ============================================================================

TEST(math_Roots_ComparisonTest, BisectionNewton_SqrtTwo)
{
  ...
  // New API
  math::ScalarResult aNewResult = math::Roots::BisectionNewton(aNewFunc, 1.0, 2.0);
...
TEST(math_Roots_ComparisonTest, BisectionNewton_CosMinusX)
{
  ...
  // New API
  math::ScalarResult aNewResult = math::Roots::BisectionNewton(aNewFunc, 0.0, 1.0);
...
TEST(math_Roots_ComparisonTest, BisectionNewton_SinPi)
{
  ...
  // New API
  math::ScalarResult aNewResult = math::Roots::BisectionNewton(aNewFunc, 2.0, 4.0);
...
// ============================================================================
// math_NewtonFunctionRoot vs math::Roots::Newton comparison tests
// ============================================================================

TEST(math_Roots_ComparisonTest, Newton_SqrtTwo)
{
  SqrtTwoFuncOld anOldFunc;
  SqrtTwoFuncNew aNewFunc;
  ...
  math::ScalarResult aNewResult = math::Roots::Newton(aNewFunc, 1.5, aConfig);
...
TEST(math_Roots_ComparisonTest, Newton_ExpMinusThree)
{
  ...
  aConfig.XTolerance = THE_TOLERANCE;
  aConfig.FTolerance = THE_TOLERANCE;
  math::ScalarResult aNewResult = math::Roots::Newton(aNewFunc, 1.0, aConfig);
...
TEST(math_Roots_ComparisonTest, Newton_CosMinusX)
{
  ...
  aConfig.XTolerance = THE_TOLERANCE;
  aConfig.FTolerance = THE_TOLERANCE;
  math::ScalarResult aNewResult = math::Roots::Newton(aNewFunc, 0.5, aConfig);
...
// ============================================================================
// math_BracketedRoot vs math::Roots::Brent comparison tests
// ============================================================================

TEST(math_Roots_ComparisonTest, Brent_SqrtTwo)
{
  SqrtTwoFuncOld anOldFunc;
  SqrtTwoFuncNew aNewFunc;
  ...
  math::Config aConfig;
  aConfig.XTolerance = THE_TOLERANCE;
  math::ScalarResult aNewResult = math::Roots::Brent(aNewFunc, 1.0, 2.0, aConfig);
...
TEST(math_Roots_ComparisonTest, Brent_CosMinusX)
{
  ...
  math::Config aConfig;
  aConfig.XTolerance = THE_TOLERANCE;
  math::ScalarResult aNewResult = math::Roots::Brent(aNewFunc, 0.0, 1.0, aConfig);
...
TEST(math_Roots_ComparisonTest, Brent_SinPi)
{
  ...
  math::Config aConfig;
  aConfig.XTolerance = THE_TOLERANCE;
  math::ScalarResult aNewResult = math::Roots::Brent(aNewFunc, 2.0, 4.0, aConfig);
...
TEST(math_Roots_ComparisonTest, Brent_ExpMinusThree)
{
  ...
  math::Config aConfig;
  aConfig.XTolerance = THE_TOLERANCE;
  math::ScalarResult aNewResult = math::Roots::Brent(aNewFunc, 0.0, 2.0, aConfig);
...
// ============================================================================
// math_FunctionRoot vs math::Roots::NewtonBounded comparison tests
// ============================================================================

TEST(math_Roots_ComparisonTest, FunctionRoot_SqrtTwo)
{
  SqrtTwoFuncOld anOldFunc;
  SqrtTwoFuncNew aNewFunc;
  ...
  math::Config aConfig;
  aConfig.XTolerance = THE_TOLERANCE;
  math::ScalarResult aNewResult = math::Roots::NewtonBounded(aNewFunc, 1.5, 1.0, 2.0, aConfig);
...
TEST(math_Roots_ComparisonTest, FunctionRoot_SinPi)
{
  ...
  math::Config aConfig;
  aConfig.XTolerance = THE_TOLERANCE;
  math::ScalarResult aNewResult = math::Roots::NewtonBounded(aNewFunc, 3.0, 2.0, 4.0, aConfig);
...
TEST(math_Roots_ComparisonTest, IterationCount_NewtonVsBrent)
{
  ...
  math::ScalarResult aNewtonResult = math::Roots::Newton(aFunc, 1.5, aConfig);
  math::ScalarResult aBrentResult  = math::Roots::Brent(aFunc, 1.0, 2.0, aConfig);
...
TEST(math_Roots_ComparisonTest, ChallengingCase_CloseToZeroDerivative)
{
  ...
  // New API - Brent
  math::ScalarResult aNewResult = math::Roots::Brent(aNewFunc, 0.0, 1.0);
