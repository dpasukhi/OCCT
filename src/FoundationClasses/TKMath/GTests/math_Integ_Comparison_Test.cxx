...
// ============================================================================
// math_GaussSingleIntegration vs math::Integ::Gauss comparison tests
// ============================================================================

TEST(math_Integ_ComparisonTest, Gauss_SinPi)
{
  ...
  // New API
  math::IntegResult aNewResult = math::Integ::Gauss(aNewFunc, 0.0, THE_PI, anOrder);
...
TEST(math_Integ_ComparisonTest, Gauss_Quadratic)
{
  ...
  // New API
  math::IntegResult aNewResult = math::Integ::Gauss(aNewFunc, 0.0, 1.0, anOrder);
...
TEST(math_Integ_ComparisonTest, Gauss_Cosine)
{
  ...
  // New API
  math::IntegResult aNewResult = math::Integ::Gauss(aNewFunc, 0.0, THE_PI / 2.0, anOrder);
...
TEST(math_Integ_ComparisonTest, Gauss_Constant)
{
  ...
  // New API
  math::IntegResult aNewResult = math::Integ::Gauss(aNewFunc, 0.0, 5.0, anOrder);
...
TEST(math_Integ_ComparisonTest, Order3_Comparison)
{
  SinFuncOld anOldFunc;
  SinFuncNew aNewFunc;

  math_GaussSingleIntegration anOldInteg(anOldFunc, 0.0, THE_PI, 3);
  math::IntegResult            aNewResult = math::Integ::Gauss(aNewFunc, 0.0, THE_PI, 3);
...
TEST(math_Integ_ComparisonTest, Order5_Comparison)
{
  ...
  math::IntegResult            aNewResult = math::Integ::Gauss(aNewFunc, 0.0, THE_PI, 5);
...
TEST(math_Integ_ComparisonTest, Order7_Comparison)
{
  ...
  math::IntegResult            aNewResult = math::Integ::Gauss(aNewFunc, 0.0, THE_PI, 7);
...
TEST(math_Integ_ComparisonTest, Order15_Comparison)
{
  ...
  math::IntegResult            aNewResult = math::Integ::Gauss(aNewFunc, 0.0, THE_PI, 15);
...
TEST(math_Integ_ComparisonTest, Order21_Comparison)
{
  ...
  math::IntegResult            aNewResult = math::Integ::Gauss(aNewFunc, 0.0, THE_PI, 21);
...
TEST(math_Integ_ComparisonTest, HigherOrderMoreAccurate)
{
  ExpFuncNew aFunc;

  const double aExact = std::exp(1.0) - 1.0;

  math::IntegResult aResult3  = math::Integ::Gauss(aFunc, 0.0, 1.0, 3);
  math::IntegResult aResult7  = math::Integ::Gauss(aFunc, 0.0, 1.0, 7);
  math::IntegResult aResult15 = math::Integ::Gauss(aFunc, 0.0, 1.0, 15);
...
TEST(math_Integ_ComparisonTest, NegativeBounds)
{
  QuadraticFuncOld anOldFunc;
  QuadraticFuncNew aNewFunc;
  ...
  // New API
  math::IntegResult aNewResult = math::Integ::Gauss(aNewFunc, -1.0, 1.0, anOrder);
...
TEST(math_Integ_ComparisonTest, ReversedBounds)
{
  SinFuncNew aFunc;

  // Normal bounds
  math::IntegResult aResultNormal = math::Integ::Gauss(aFunc, 0.0, THE_PI, 15);

  // Reversed bounds
  math::IntegResult aResultReversed = math::Integ::Gauss(aFunc, THE_PI, 0.0, 15);
...
TEST(math_Integ_ComparisonTest, PolynomialExactness_Order3)
{
...
TEST(math_Integ_ComparisonTest, LargeInterval)
{
  ExpFuncOld anOldFunc;
  ExpFuncNew aNewFunc;
  ...
  // New API
  math::IntegResult aNewResult = math::Integ::Gauss(aNewFunc, 0.0, 10.0, anOrder);
...
TEST(math_Integ_ComparisonTest, SmallInterval)
{
  SinFuncOld anOldFunc;
  SinFuncNew aNewFunc;
  ...
  // New API
  math::IntegResult aNewResult = math::Integ::Gauss(aNewFunc, 0.0, 0.001, anOrder);
