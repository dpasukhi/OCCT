...
TEST(math_Min_Newton_NewTest, Quadratic)
{
  QuadraticFunc aFunc;
  ...
  math::Min::NewtonConfig aConfig;
  aConfig.MaxIterations = 50;
  aConfig.Tolerance     = 1.0e-10;

  auto aResult = math::Min::Newton(aFunc, aStart, aConfig);
...
TEST(math_Min_Newton_NewTest, Booth)
{
  BoothFunc aFunc;
...
TEST(math_Min_Newton_NewTest, Rosenbrock)
{
...
TEST(math_Min_Newton_NewTest, Sphere3D)
{
  SphereFunc aFunc;
...
TEST(math_Min_Newton_NewTest, ModifiedNewton_Quadratic)
{
  QuadraticFunc aFunc;
  ...
  auto aResult = math::Min::NewtonModified(aFunc, aStart, aConfig);
...
TEST(math_Min_Newton_NewTest, ModifiedNewton_Rosenbrock)
{
  RosenbrockFunc aFunc;
...
TEST(math_Min_Newton_NewTest, NumericalHessian_Quadratic)
{
  ...
  auto aResult = math::Min::NewtonNumericalHessian(aFunc, aStart, 1.0e-6, aConfig);
...
TEST(math_Min_Newton_NewTest, FullNumerical_Quadratic)
{
  ...
  auto aResult = math::Min::NewtonNumerical(aFunc, aStart, 1.0e-8, 1.0e-6, aConfig);
...
TEST(math_Min_Newton_NewTest, CompareWithOldAPI_Quadratic)
{
  ...
  aConfig.MaxIterations = 50;
  aConfig.Tolerance     = 1.0e-10;
  auto aNewResult       = math::Min::Newton(aNewFunc, aStart, aConfig);
...
TEST(math_Min_Newton_NewTest, CompareWithOldAPI_Booth)
{
...
TEST(math_Min_Newton_NewTest, CompareWithBFGS)
{
  ...
  math::Config aBFGSConfig;
  aBFGSConfig.MaxIterations = 100;
  aBFGSConfig.XTolerance    = 1.0e-10;
  aBFGSConfig.FTolerance    = 1.0e-12;

  math::Min::NewtonConfig aNewtonConfig;
  aNewtonConfig.MaxIterations = 50;
  aNewtonConfig.Tolerance     = 1.0e-10;

  auto aNewtonResult = math::Min::Newton(aQuadFunc, aStart, aNewtonConfig);
  auto aBFGSResult   = math::Min::BFGS(aBFGSFunc, aStart, aBFGSConfig);
...
TEST(math_Min_Newton_NewTest, QuadraticConvergence)
{
  QuadraticFunc aFunc;
