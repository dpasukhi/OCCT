...
#include <math_Sys_LevenbergMarquardt.hxx>
...
TEST(math_Sys_LM_NewTest, LinearSystem2D)
{
  ...
  math::Sys::LMConfig aConfig;
  aConfig.Tolerance     = 1.0e-10;
  aConfig.FTolerance    = 1.0e-10;
  aConfig.MaxIterations = 100;

  auto aResult = math::Sys::LevenbergMarquardt(aFunc, aStart, aConfig);
...
TEST(math_Sys_LM_NewTest, CircleHyperbola)
{
...
TEST(math_Sys_LM_NewTest, RosenbrockResidual)
{
...
TEST(math_Sys_LM_NewTest, PowellSingular)
{
...
TEST(math_Sys_LM_NewTest, OverdeterminedSystem)
{
...
TEST(math_Sys_LM_NewTest, ExponentialFit)
{
...
TEST(math_Sys_LM_NewTest, BoundedCircleHyperbola)
{
  CircleHyperbola aFunc;
  ...
  auto aResult = math::Sys::LevenbergMarquardtBounded(aFunc, aStart, aLower, aUpper, aConfig);
...
TEST(math_Sys_LM_NewTest, BoundedRosenbrock)
{
  RosenbrockResidual aFunc;
...
TEST(math_Sys_LM_NewTest, BoundedActiveConstraint)
{
...
TEST(math_Sys_LM_NewTest, DampingParameters)
{
  CircleHyperbola aFunc;
...
TEST(math_Sys_LM_NewTest, LambdaUpdateFactors)
{
  RosenbrockResidual aFunc;
...
TEST(math_Sys_LM_NewTest, CompareWithOldAPI_CircleHyperbola)
{
  ...
  aConfig.FTolerance    = 1.0e-10;
  aConfig.MaxIterations = 100;
  auto aNewResult       = math::Sys::LevenbergMarquardt(aNewFunc, aStart, aConfig);
...
TEST(math_Sys_LM_NewTest, CompareWithOldAPI_Rosenbrock)
{
...
TEST(math_Sys_LM_NewTest, CompareWithOldAPI_Bounded)
{
  CircleHyperbolaOld anOldFunc;
  CircleHyperbola    aNewFunc;
  ...
  aConfig.FTolerance    = 1.0e-10;
  aConfig.MaxIterations = 100;
  auto aNewResult = math::Sys::LevenbergMarquardtBounded(aNewFunc, aStart, aLower, aUpper, aConfig);
...
TEST(math_Sys_LM_NewTest, DifferentStartingPoints)
{
  CircleHyperbola aFunc;
...
TEST(math_Sys_LM_NewTest, ConvergenceIterations)
{
  LinearSystem2D aFunc;
...
TEST(math_Sys_LM_NewTest, MaxIterationsReached)
{
  RosenbrockResidual aFunc;
...
TEST(math_Sys_LM_NewTest, InvalidInputDimensions)
{
  LinearSystem2D aFunc;
...
TEST(math_Sys_LM_NewTest, BoundedInvalidDimensions)
{
  LinearSystem2D aFunc;
