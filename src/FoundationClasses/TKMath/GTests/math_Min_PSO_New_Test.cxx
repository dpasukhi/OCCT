...
TEST(math_Min_PSO_NewTest, Sphere2D)
{
  SphereFunc aFunc;
...
TEST(math_Min_PSO_NewTest, Sphere3D)
{
  SphereFunc aFunc;
...
TEST(math_Min_PSO_NewTest, Booth)
{
  BoothFunc aFunc;
...
TEST(math_Min_PSO_NewTest, Rosenbrock)
{
...
TEST(math_Min_PSO_NewTest, Rastrigin2D)
{
  RastriginFunc aFunc;
...
TEST(math_Min_PSO_NewTest, Ackley2D)
{
  AckleyFunc aFunc;
...
TEST(math_Min_PSO_NewTest, ParameterSensitivity_Omega)
{
  SphereFunc aFunc;
...
TEST(math_Min_PSO_NewTest, ParameterSensitivity_SwarmSize)
{
  SphereFunc aFunc;
...
TEST(math_Min_PSO_NewTest, Reproducibility)
{
  SphereFunc aFunc;
  ...
  auto aResult1 = math::Min::PSO(aFunc, aLower, aUpper, aConfig);
  auto aResult2 = math::Min::PSO(aFunc, aLower, aUpper, aConfig);
...
TEST(math_Min_PSO_NewTest, CompareWithOldAPI_Sphere)
{
  ...
  aConfig.Seed          = 12345;
  auto aNewResult       = math::Min::PSO(aNewFunc, aLower, aUpper, aConfig);
...
TEST(math_Min_PSO_NewTest, Sphere5D)
{
  SphereFunc aFunc;
...
TEST(math_Min_PSO_NewTest, AsymmetricBounds)
{
  BoothFunc aFunc;
