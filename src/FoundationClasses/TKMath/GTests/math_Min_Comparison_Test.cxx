...
// ============================================================================
// math_BrentMinimum vs math::Min::Brent comparison tests
// ============================================================================

TEST(math_Min_ComparisonTest, Brent_Parabola)
{
  ...
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, 0.0, 6.0);
...
TEST(math_Min_ComparisonTest, Brent_ParabolaNegativeMinimum)
{
  ...
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, 0.0, 5.0);
...
TEST(math_Min_ComparisonTest, Brent_Cosine)
{
  ...
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, 2.0, 4.0);
...
TEST(math_Min_ComparisonTest, Brent_QuarticRight)
{
  ...
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, 0.0, 2.0);
...
TEST(math_Min_ComparisonTest, Brent_QuarticLeft)
{
  ...
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, -2.0, 0.0);
...
TEST(math_Min_ComparisonTest, Brent_CoshLike)
{
  ...
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, -5.0, 5.0);
...
TEST(math_Min_ComparisonTest, Brent_Square)
{
  ...
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, -10.0, 10.0);
...
TEST(math_Min_ComparisonTest, IterationCount_BrentVsGolden)
{
  ...
  math::ScalarResult aBrentResult  = math::Min::Brent(aFunc, 0.0, 10.0, aConfig);
  math::ScalarResult aGoldenResult = math::Min::Golden(aFunc, 0.0, 10.0, aConfig);
...
TEST(math_Min_ComparisonTest, Accuracy_BrentVsOld)
{
  ParabolaFuncOld anOldFunc;
  ParabolaFuncNew aNewFunc;
  ...
  aConfig.MaxIterations = 200;
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, 0.0, 10.0, aConfig);
...
TEST(math_Min_ComparisonTest, WideInterval_Parabola)
{
  ParabolaFuncOld anOldFunc;
  ParabolaFuncNew aNewFunc;
  ...
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, -100.0, 100.0);
...
TEST(math_Min_ComparisonTest, NarrowInterval_Parabola)
{
  ParabolaFuncOld anOldFunc;
  ParabolaFuncNew aNewFunc;
  ...
  math::ScalarResult aNewResult = math::Min::Brent(aNewFunc, 2.9, 3.1);
...
// ============================================================================
// math::Min::Golden comparison tests
// ============================================================================

TEST(math_Min_ComparisonTest, Golden_Parabola)
{
  ParabolaFuncNew aNewFunc;

  // Golden section should find the same minimum as Brent
  math::ScalarResult aBrentResult  = math::Min::Brent(aNewFunc, 0.0, 10.0);
  math::ScalarResult aGoldenResult = math::Min::Golden(aNewFunc, 0.0, 10.0);
...
TEST(math_Min_ComparisonTest, Golden_CoshLike)
{
  ...
  math::ScalarResult aBrentResult  = math::Min::Brent(aNewFunc, -5.0, 5.0);
  math::ScalarResult aGoldenResult = math::Min::Golden(aNewFunc, -5.0, 5.0);
