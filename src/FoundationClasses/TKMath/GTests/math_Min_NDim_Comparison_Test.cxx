...
// ============================================================================
// math_Powell vs math::Min::Powell comparison tests
// ============================================================================

TEST(math_Min_NDim_ComparisonTest, Powell_Quadratic)
{
  ...
  auto aNewResult       = math::Min::Powell(aNewFunc, aStart, aConfig);
...
TEST(math_Min_NDim_ComparisonTest, Powell_Booth)
{
...
TEST(math_Min_NDim_ComparisonTest, Powell_Rosenbrock)
{
...
TEST(math_Min_NDim_ComparisonTest, Powell_Sphere3D)
{
...
// ============================================================================
// math_BFGS vs math::Min::BFGS comparison tests
// ============================================================================

TEST(math_Min_NDim_ComparisonTest, BFGS_Quadratic)
{
  ...
  aConfig.XTolerance    = 1.0e-8;
  aConfig.FTolerance    = 1.0e-10;
  auto aNewResult       = math::Min::BFGS(aNewFunc, aStart, aConfig);
...
TEST(math_Min_NDim_ComparisonTest, BFGS_Booth)
{
...
TEST(math_Min_NDim_ComparisonTest, BFGS_Rosenbrock)
{
...
TEST(math_Min_NDim_ComparisonTest, BFGS_Sphere3D)
{
...
TEST(math_Min_NDim_ComparisonTest, IterationCount_BFGSVsPowell)
{
  QuadraticFuncNew aNewFunc;
  ...
  auto aPowellResult = math::Min::Powell(aNewFunc, aStart, aConfig);
  auto aBFGSResult   = math::Min::BFGS(aNewFunc, aStart, aConfig);
...
TEST(math_Min_NDim_ComparisonTest, IterationCount_LBFGSVsBFGS)
{
  SphereFuncNew aNewFunc;
  ...
  auto aBFGSResult  = math::Min::BFGS(aNewFunc, aStart, aConfig);
  auto aLBFGSResult = math::Min::LBFGS(aNewFunc, aStart, 10, aConfig);
...
TEST(math_Min_NDim_ComparisonTest, Accuracy_BFGSVsOld)
{
  QuadraticFuncGradOld anOldFunc;
  QuadraticFuncNew     aNewFunc;
...
TEST(math_Min_NDim_ComparisonTest, DifferentStartingPoints)
{
  QuadraticFuncGradOld anOldFunc;
  QuadraticFuncNew     aNewFunc;
