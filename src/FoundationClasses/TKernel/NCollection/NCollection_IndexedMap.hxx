...
public:
  ...
  public:
    ...
    {
      Standard_Raise_if<Standard_NoSuchObject>(!More(), "NCollection_IndexedMap::Iterator::Value");
...
public:
  ...
  void RemoveLast(void)
  {
    ...
    Standard_Raise_if<Standard_OutOfRange>(aLastIndex == 0, "NCollection_IndexedMap::RemoveLast");
