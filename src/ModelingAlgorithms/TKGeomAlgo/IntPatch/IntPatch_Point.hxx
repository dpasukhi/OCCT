...
public:
  ...
  const Handle(GeomAdaptor_HVertex)& VertexOnS1() const;
  ...
  //! Otherwise, an exception is raised.
  const Handle(GeomAdaptor_HVertex)& VertexOnS2() const;
...
private:
  ...
  Handle(GeomAdaptor_HVertex) vS1;
  ...
  Handle(GeomAdaptor_HVertex) vS2;
