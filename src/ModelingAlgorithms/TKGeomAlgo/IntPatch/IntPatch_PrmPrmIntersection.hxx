...
public:
  ...
  Standard_EXPORT void Perform(const Handle(GeomAdaptor_Surface)&   Caro1,
  ...
  Standard_EXPORT Handle(IntPatch_Line) NewLine(const Handle(GeomAdaptor_Surface)& Caro1,
                                                const Handle(GeomAdaptor_Surface)& Caro2,
