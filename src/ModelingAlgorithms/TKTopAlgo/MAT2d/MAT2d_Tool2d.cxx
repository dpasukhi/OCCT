...
namespace
{
constexpr double THE_CONFUSION_TOLERANCE = 1.0e-7;
} // namespace
...
{
  return 2.0 * THE_CONFUSION_TOLERANCE;
}
...
void MAT2d_Tool2d::CreateBisector(const occ::handle<MAT_Bisector>& abisector)
{
  ...
  double                       tolerance = THE_CONFUSION_TOLERANCE;
...
bool MAT2d_Tool2d::Projection(const int IEdge, const gp_Pnt2d& PCom, double& Distance) const
{
  ...
  int                              INext;
  double                           Eps = THE_CONFUSION_TOLERANCE; //*10.;
                                  ...
                                  double&                          Distance) const
{
  ...
  double EpsDist = THE_CONFUSION_TOLERANCE * 300.0;
  Distance       = Dist(1);
