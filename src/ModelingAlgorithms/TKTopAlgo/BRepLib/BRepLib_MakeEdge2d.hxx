...
public:
  ...
  Standard_EXPORT explicit BRepLib_MakeEdge2d(const gp_Pln& thePlane);
...
private:
  //! Clears the previous result before starting a new construction.
  void reset();

  BRepLib_EdgeError       myError = BRepLib_EdgeDone;
