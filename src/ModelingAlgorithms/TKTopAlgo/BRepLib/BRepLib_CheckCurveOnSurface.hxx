...
protected:
  ...
  Standard_EXPORT void Compute(const Handle(GeomAdaptor_CurveOnSurface)& theCurveOnSurface);

private:
  GeomLib_CheckCurveOnSurface      myCOnSurfGeom;
  Handle(GeomAdaptor_CurveOnSurface) myAdaptorCurveOnSurface;
  Handle(GeomAdaptor_CurveOnSurface) myAdaptorCurveOnSurface2;
