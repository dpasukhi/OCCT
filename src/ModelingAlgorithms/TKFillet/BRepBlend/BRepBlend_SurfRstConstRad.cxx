...
BRepBlend_SurfRstConstRad::BRepBlend_SurfRstConstRad(const Handle(GeomAdaptor_Surface)& Surf,
...
void BRepBlend_SurfRstConstRad::Set(const Handle(GeomAdaptor_Surface)& SurfRef,
