...
public:
  ...
  static Standard_Real Parameter(const Handle(GeomAdaptor_HVertex)& V,
  ...
  static Standard_Real Tolerance(const Handle(GeomAdaptor_HVertex)& V,
                                 const Handle(Geom2dAdaptor_Curve)& A);
  ...
  static Handle(Geom2dAdaptor_Curve) CurveOnSurf(const Handle(Geom2dAdaptor_Curve)& C,
                                               const Handle(GeomAdaptor_Surface)& S);
