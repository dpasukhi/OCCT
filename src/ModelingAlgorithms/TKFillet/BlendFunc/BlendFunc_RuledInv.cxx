...
BlendFunc_RuledInv::BlendFunc_RuledInv(const Handle(GeomAdaptor_Surface)& S1,
...
void BlendFunc_RuledInv::Set(const Standard_Boolean OnFirst, const Handle(Geom2dAdaptor_Curve)& C)
{
  first = OnFirst;
  csurf = C;
}
