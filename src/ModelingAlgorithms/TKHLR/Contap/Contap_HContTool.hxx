...
public:
  ...
  Standard_EXPORT static Standard_Integer NbSamplePoints(const Handle(GeomAdaptor_Surface)& S);

  Standard_EXPORT static void SamplePoint(const Handle(GeomAdaptor_Surface)& S,
