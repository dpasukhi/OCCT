...
inline const Handle(GeomAdaptor_HVertex)& Contap_ThePathPointOfTheSearch::Vertex() const
{
  if (isnew)
  {
...
inline const Handle(Geom2dAdaptor_Curve)& Contap_ThePathPointOfTheSearch::Arc() const
{
  return arc;
}
