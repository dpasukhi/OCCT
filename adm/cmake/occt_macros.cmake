...
function (REGISTER_TOOLKIT_HEADERS OCCT_TOOLKIT INCLUDE_FILES)
  set_property(GLOBAL APPEND PROPERTY OCCT_TOOLKIT_${OCCT_TOOLKIT}_INCLUDE_FILES ${INCLUDE_FILES})
endfunction()

function (LOAD_TOOLKIT_HEADERS OCCT_TOOLKIT INCLUDE_FILES)
  get_property(OCCT_TOOLKIT_INCLUDE_FILES GLOBAL PROPERTY OCCT_TOOLKIT_${OCCT_TOOLKIT}_INCLUDE_FILES)
  set (${INCLUDE_FILES} ${OCCT_TOOLKIT_INCLUDE_FILES} PARENT_SCOPE)
endfunction()
...
macro (COLLECT_AND_INSTALL_OCCT_HEADER_FILES ROOT_TARGET_OCCT_DIR OCCT_BUILD_TOOLKITS OCCT_COLLECT_SOURCE_DIR OCCT_INSTALL_DIR_PREFIX)
  ...
  get_property(PROCESSED_TOOLKITS GLOBAL PROPERTY PROCESSED_TOOLKITS_WITH_INCLUDES)

  foreach(TOOLKIT_PROCESSED ${PROCESSED_TOOLKITS_WITH_INCLUDES})
    list(REMOVE_ITEM OCCT_BUILD_TOOLKITS ${TOOLKIT_PROCESSED})
  endforeach()

  set (OCCT_HEADER_FILES_COMPLETE)

  foreach(OCCT_TOOLKIT OCCT_BUILD_TOOLKITS)
    LOAD_TOOLKIT_HEADERS (OCCT_TOOLKIT OCCT_INCLUDE_FILES)
    list (APPEND OCCT_HEADER_FILES_COMPLETE ${OCCT_INCLUDE_FILES})
  endforeach()
  ...
  foreach (OCCT_HEADER_FILE ${OCCT_HEADER_FILES_COMPLETE})
    ...
    if (BUILD_INCLUDE_SYMLINK)
      ...
      file (CREATE_LINK "${OCCT_HEADER_FILE}" "${ROOT_TARGET_OCCT_DIR}/${OCCT_INSTALL_DIR_PREFIX}/${HEADER_FILE_NAME}" SYMBOLIC)
    else()
      get_filename_component (HEADER_FILE_NAME ${OCCT_HEADER_FILE} NAME)
