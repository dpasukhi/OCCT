...
function (EXTRACT_PACKAGE_FILES RELATIVE_PATH OCCT_PACKAGE RESULT_FILES RESULT_INCLUDE_FOLDER)
  ...
  foreach (OCCT_FILE ${OCCT_PACKAGE_FILES})
    ...
    if (BUILD_PATCH AND EXISTS "${BUILD_PATCH}/${RELATIVE_PATH}/${OCCT_PACKAGE}/${OCCT_FILE}")
      list (APPEND FILE_PATH_LIST "${BUILD_PATCH}/${RELATIVE_PATH}/${OCCT_PACKAGE}/${OCCT_FILE}")
    elseif (EXISTS "${CMAKE_SOURCE_DIR}/${RELATIVE_PATH}/${OCCT_PACKAGE}/${OCCT_FILE}")
      list (APPEND FILE_PATH_LIST "${CMAKE_SOURCE_DIR}/${RELATIVE_PATH}/${OCCT_PACKAGE}/${OCCT_FILE}")
    endif()
  endforeach()
...
function(EXCTRACT_TOOLKIT_DEPS RELATIVE_PATH OCCT_TOOLKIT RESULT_TKS_AS_DEPS RESULT_INCLUDE_FOLDERS)
  ...
  endforeach()
  set (OCCT_TOOLKIT_FILES)
  set (OCCT_TOOLKIT_INCLUDE_DIR)
  EXTRACT_PACKAGE_FILES (${RELATIVE_PATH} ${OCCT_TOOLKIT} OCCT_TOOLKIT_FILES OCCT_TOOLKIT_INCLUDE_DIR)
  set (${RESULT_TKS_AS_DEPS} ${OCCT_TOOLKIT_DEPS} PARENT_SCOPE)
  set (${RESULT_INCLUDE_FOLDERS} ${OCCT_TOOLKIT_INCLUDE_DIR} PARENT_SCOPE)
  set_property(GLOBAL PROPERTY OCCT_TOOLKIT_${OCCT_TOOLKIT}_DEPS "${OCCT_TOOLKIT_DEPS}")
  set_property(GLOBAL PROPERTY OCCT_TOOLKIT_${OCCT_TOOLKIT}_INCLUDE_FOLDERS "${OCCT_TOOLKIT_INCLUDE_DIR}")
endfunction()
...
macro (COLLECT_AND_INSTALL_OCCT_HEADER_FILES ROOT_TARGET_OCCT_DIR OCCT_BUILD_TOOLKITS OCCT_COLLECT_SOURCE_DIR OCCT_INSTALL_DIR_PREFIX)
  ...
  foreach (OCCT_USED_TOOLKIT ${OCCT_BUILD_TOOLKITS})
    ...
    set (OCCT_TOOLKIT_PACKAGES "")
    EXTRACT_TOOLKIT_PACKAGES ("src" ${OCCT_USED_TOOLKIT} OCCT_TOOLKIT_PACKAGES)
  ...
  foreach (OCCT_PACKAGE ${OCCT_USED_PACKAGES})
    set (OCCT_ALL_FILE_PATHS)
    set (OCCT_INCLUDE_DIR)
    EXTRACT_PACKAGE_FILES ("src" ${OCCT_PACKAGE} OCCT_ALL_FILE_PATHS OCCT_INCLUDE_DIR)
    foreach(OCCT_PACKAGE_FILE OCCT_ALL_FILE_PATHS)
      string (REGEX MATCH ".+\\.[hlg]xx|.+\\.h$" IS_HEADER_FOUND "${OCCT_PACKAGE_FILE}")
      if (IS_HEADER_FOUND)
        list (APPEND OCCT_HEADER_FILES_COMPLETE ${OCCT_PACKAGE_FILE})
      endif()
    endforeach(OCCT_PACKAGE_FILE )
  endforeach()
