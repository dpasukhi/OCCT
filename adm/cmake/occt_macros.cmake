...
function (PREPARE_OCCT_INCLUDE_FILE INCLUDE_FILE_LIST)
  # copying headers to the build directory
  if (CMAKE_VERSION VERSION_GREATER_EQUAL "3.14")
    foreach(INC_FILE ${INCLUDE_FILE_LIST})
    ...
    foreach (OCCT_HEADER_FILE ${INCLUDE_FILE_LIST})
      get_filename_component (HEADER_FILE_NAME ${OCCT_HEADER_FILE} NAME)
      set (OCCT_HEADER_FILE_CONTENT "#include \"${OCCT_HEADER_FILE}\"")
      configure_file ("${TEMPLATE_HEADER_PATH}" "${CMAKE_BINARY_DIR}/${INSTALL_DIR_INCLUDE}/${HEADER_FILE_NAME}" @ONLY)
    endforeach()
  endif()
  # installing headers during the INSTALL stage
  install (FILES ${INCLUDE_FILE_LIST} DESTINATION "${INSTALL_DIR}/${INSTALL_DIR_INCLUDE}")
endfunction()
