...
function(add_precompiled_header target header)
  ...
  if(MSVC)
    ...
    target_compile_options(${target} PRIVATE /Yc${header})
    target_compile_options(${target} PRIVATE /Fp${CMAKE_BINARY_DIR}/${target}_pch.pch)
  elseif(CMAKE_COMPILER_IS_GNUCXX OR CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    target_precompile_headers(${target} PUBLIC "$<$<COMPILE_LANGUAGE:CXX>:${header}>")
  endif()
endfunction()
