...
set (USED_INCLUDE_DIRS_BY_CURRENT_PROJECT)
set (USED_EXTERNLIB_AND_TOOLKITS)

# SOME EXECUTABLE PROJECTS MAY USE CUSTOM TOOLKITS AND EXTERNAL LIBRARIES
if (CUSTOM_USED_TOOLKITS_BY_CURRENT_PROJECT AND CUSTOM_USED_EXTERNAL_LIBS_BY_CURRENT_PROJECT AND CUSTOM_USED_INCLUDE_DIRS_BY_CURRENT_PROJECT)
  set (USED_EXTERNAL_LIBS_BY_CURRENT_PROJECT ${CUSTOM_USED_EXTERNAL_LIBS_BY_CURRENT_PROJECT})
  set (USED_TOOLKITS_BY_CURRENT_PROJECT ${CUSTOM_USED_TOOLKITS_BY_CURRENT_PROJECT})
  set (USED_INCLUDE_DIRS_BY_CURRENT_PROJECT ${CUSTOM_USED_INCLUDE_DIRS_BY_CURRENT_PROJECT})
else()
  EXTRACT_TOOLKIT_EXTERNLIB ("${RELATIVE_SOURCES_DIR}" "${PROJECT_NAME}" USED_EXTERNLIB_AND_TOOLKITS)
  #EXCTRACT_TOOLKIT_DEPS ("${RELATIVE_SOURCES_DIR}" "${PROJECT_NAME}" USED_TOOLKITS_BY_CURRENT_PROJECT USED_INCLUDE_DIRS_BY_CURRENT_PROJECT)

  EXCTRACT_TOOLKIT_FULL_DEPS ("${RELATIVE_SOURCES_DIR}" "${PROJECT_NAME}" _ USED_INCLUDE_DIRS_BY_CURRENT_PROJECT)
...
# TODO:
# Process include folders based on used TKs
if (NOT "${USED_INCLUDE_DIRS_BY_CURRENT_PROJECT}" STREQUAL "")
  target_include_directories(${PROJECT_NAME} PRIVATE ${USED_INCLUDE_DIRS_BY_CURRENT_PROJECT})
endif()
