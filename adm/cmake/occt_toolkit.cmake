...
if (CUSTOM_USED_TOOLKITS_BY_CURRENT_PROJECT AND CUSTOM_USED_EXTERNAL_LIBS_BY_CURRENT_PROJECT)
  set (USED_EXTERNLIB_AND_TOOLKITS ${CUSTOM_USED_EXTERNAL_LIBS_BY_CURRENT_PROJECT})
...
get_property(TOOLKIT_INCLUDE_DIR_LIST GLOBAL PROPERTY OCCT_TOOLKIT_${PROJECT_NAME}_INCLUDE_DIRS)
foreach(DEPENDS_TOOLKIT ${USED_TOOLKITS_BY_CURRENT_PROJECT})
  get_property(DEPENDS_TOOLKIT_INCLUDE_DIR GLOBAL PROPERTY OCCT_TOOLKIT_${DEPENDS_TOOLKIT}_INCLUDE_DIRS)
  if (NOT DEPENDS_TOOLKIT_INCLUDE_DIR)
    continue()
  endif()
  list (APPEND TOOLKIT_INCLUDE_DIR_LIST ${DEPENDS_TOOLKIT_INCLUDE_DIR})
endforeach()

if (NOT "${TOOLKIT_INCLUDE_DIR_LIST}" STREQUAL "")
  target_include_directories(${PROJECT_NAME} PRIVATE ${TOOLKIT_INCLUDE_DIR_LIST})
endif()
