...
function (JEMALLOC_LIB_SEARCH MMGR_LIB PREFIX)
  ...
  message(STATUS "Info: JEMALLOC library found: ${3RDPARTY_JEMALLOC_LIBRARY_${PREFIX}_${MMGR_LIB}}")
  message(STATUS "Info: JEMALLOC library directory: ${3RDPARTY_JEMALLOC_LIBRARY_DIR_${MMGR_LIB}}")
  if (${JEMALLOC_IS_STATIC_LIB})
    get_filename_component(STATIC_LIB_NAME ${3RDPARTY_JEMALLOC_LIBRARY_${PREFIX}_${MMGR_LIB}} NAME)
    list(APPEND CSF_MMGR "${STATIC_LIB_NAME}" PARENT_SCOPE)
    message(STATUS "INFO: JEMALLOC library: ${STATIC_LIB_NAME}")
  endif()
...
if (BUILD_USE_VCPKG)
  ...
  message(STATUS "Info: JEMALLOC include directory is ${VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/include/jemalloc")
  message(STATUS "Info: JEMALLOC library directory is ${3RDPARTY_JEMALLOC_LIBRARY_DIR}")
  message(STATUS "INFO: JEMALLOC libraries: ${CSF_MMGR}")
  return()
endif()
