...
#
# Script for modernizing OCCT codebase for version 8.0.0
# Handles: Handle(Class) -> occ::handle<Class>
#          Handle(Class)::DownCast -> occ::down_cast<Class>
#          Standard_* types -> native C++ types
