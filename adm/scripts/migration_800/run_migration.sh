...
# Phase 6: Collect NCollection typedefs
echo ""
echo "=============================================="
echo "Phase 6: Collect NCollection Typedefs"
echo "=============================================="
python3 "$SCRIPT_DIR/collect_typedefs.py" "$SRC_DIR" --output collected_typedefs.json

# Phase 7: Replace typedef usages with direct NCollection types
echo ""
echo "=============================================="
echo "Phase 7: Replace Typedef Usages"
echo "=============================================="
python3 "$SCRIPT_DIR/replace_typedefs.py" $DRY_RUN "$SRC_DIR" --input collected_typedefs.json

# Phase 8: Remove typedef-only headers
echo ""
echo "=============================================="
echo "Phase 8: Remove Typedef-Only Headers"
echo "=============================================="
python3 "$SCRIPT_DIR/remove_typedef_headers.py" $DRY_RUN "$SRC_DIR" --input collected_typedefs.json

# Phase 9: Cleanup redundant access specifiers
echo ""
echo "=============================================="
echo "Phase 9: Cleanup Access Specifiers"
echo "=============================================="
